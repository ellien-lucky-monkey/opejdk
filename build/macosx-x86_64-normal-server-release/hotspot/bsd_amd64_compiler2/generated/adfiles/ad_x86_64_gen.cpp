...
MachOper *State::MachOperGenerator(int opcode, Compile* C){
  ...
  case _LOADL_IMML32_:    return NULL;
...
MachNode *State::MachNodeGenerator(int opcode, Compile* C){
  ...
  case addExactI_rReg_rule: {
      addExactI_rRegNode *node = new (C) addExactI_rRegNode();
      return node;
    }
  case addExactI_rReg_imm_rule: {
      addExactI_rReg_immNode *node = new (C) addExactI_rReg_immNode();
      return node;
    }
  case addExactI_rReg_mem_rule: {
      addExactI_rReg_memNode *node = new (C) addExactI_rReg_memNode();
      return node;
    }
  case addExactL_rReg_rule: {
      addExactL_rRegNode *node = new (C) addExactL_rRegNode();
      return node;
    }
  case addExactL_rReg_imm_rule: {
      addExactL_rReg_immNode *node = new (C) addExactL_rReg_immNode();
      return node;
    }
  case addExactL_rReg_mem_rule: {
      addExactL_rReg_memNode *node = new (C) addExactL_rReg_memNode();
      return node;
    }
  case addI_rReg_rule: {
  ...
  case subExactI_rReg_rule: {
      subExactI_rRegNode *node = new (C) subExactI_rRegNode();
      return node;
    }
  case subExactI_rReg_imm_rule: {
      subExactI_rReg_immNode *node = new (C) subExactI_rReg_immNode();
      return node;
    }
  case subExactI_rReg_mem_rule: {
      subExactI_rReg_memNode *node = new (C) subExactI_rReg_memNode();
      return node;
    }
  case subExactL_rReg_rule: {
      subExactL_rRegNode *node = new (C) subExactL_rRegNode();
      return node;
    }
  case subExactL_rReg_imm_rule: {
      subExactL_rReg_immNode *node = new (C) subExactL_rReg_immNode();
      return node;
    }
  case subExactL_rReg_mem_rule: {
      subExactL_rReg_memNode *node = new (C) subExactL_rReg_memNode();
      return node;
    }
  case subL_rReg_rule: {
  ...
  case negExactI_rReg_rule: {
      negExactI_rRegNode *node = new (C) negExactI_rRegNode();
      return node;
    }
  case negExactL_rReg_rule: {
      negExactL_rRegNode *node = new (C) negExactL_rRegNode();
      return node;
    }
  case mulI_rReg_rule: {
  ...
  case mulExactI_rReg_rule: {
      mulExactI_rRegNode *node = new (C) mulExactI_rRegNode();
      return node;
    }
  case mulExactI_rReg_imm_rule: {
      mulExactI_rReg_immNode *node = new (C) mulExactI_rReg_immNode();
      return node;
    }
  case mulExactI_rReg_mem_rule: {
      mulExactI_rReg_memNode *node = new (C) mulExactI_rReg_memNode();
      return node;
    }
  case mulExactL_rReg_rule: {
      mulExactL_rRegNode *node = new (C) mulExactL_rRegNode();
      return node;
    }
  case mulExactL_rReg_imm_rule: {
      mulExactL_rReg_immNode *node = new (C) mulExactL_rReg_immNode();
      return node;
    }
  case mulExactL_rReg_mem_rule: {
      mulExactL_rReg_memNode *node = new (C) mulExactL_rReg_memNode();
      return node;
    }
  case divI_rReg_rule: {
