...
void cmpOpOper::int_format(PhaseRegAlloc *ra, const MachNode *node, outputStream *st) const {
  ...
  else if( _c0 == BoolTest::overflow ) st->print("o");
  else if( _c0 == BoolTest::no_overflow ) st->print("no");
}
...
void encodeKlass_not_nullNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  ...
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// src
  st->print("encode_klass_not_null ");
  opnd_array(0)->int_format(ra, this, st); // dst
  st->print(",");
  opnd_array(1)->ext_format(ra, this,idx1, st); // src
}
...
void decodeKlass_not_nullNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  ...
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// src
  st->print("decode_klass_not_null ");
  opnd_array(0)->int_format(ra, this, st); // dst
  st->print(",");
  opnd_array(1)->ext_format(ra, this,idx1, st); // src
}
...
#endif
#ifndef PRODUCT
void addExactI_rRegNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
  ...
  st->print(", ");
  opnd_array(2)->ext_format(ra, this,idx2, st); // src
  st->print("\t# addExact int");
}
#endif
#ifndef PRODUCT
void addExactI_rReg_immNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
...
#endif
#ifndef PRODUCT
void addExactI_rReg_memNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 2;
  unsigned idx1 = 2; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
...
#endif
#ifndef PRODUCT
void addExactL_rRegNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
  ...
  st->print(", ");
  opnd_array(2)->ext_format(ra, this,idx2, st); // src
  st->print("\t# addExact long");
}
#endif
#ifndef PRODUCT
void addExactL_rReg_immNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
...
#endif
#ifndef PRODUCT
void addExactL_rReg_memNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 2;
  unsigned idx1 = 2; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
...
#endif
#ifndef PRODUCT
void subExactI_rRegNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
  ...
  st->print(", ");
  opnd_array(2)->ext_format(ra, this,idx2, st); // src
  st->print("\t# subExact int");
}
#endif
#ifndef PRODUCT
void subExactI_rReg_immNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
...
#endif
#ifndef PRODUCT
void subExactI_rReg_memNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 2;
  unsigned idx1 = 2; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
...
#endif
#ifndef PRODUCT
void subExactL_rRegNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
  ...
  st->print(", ");
  opnd_array(2)->ext_format(ra, this,idx2, st); // src
  st->print("\t# subExact long");
}
#endif
#ifndef PRODUCT
void subExactL_rReg_immNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 2;
  unsigned idx1 = 2; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
...
#endif
#ifndef PRODUCT
void subExactL_rReg_memNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
...
#endif
#ifndef PRODUCT
void negExactI_rRegNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// cr
  st->print("negl    ");
  opnd_array(1)->ext_format(ra, this,idx1, st); // dst
  st->print("\t# negExact int");
}
#endif
#ifndef PRODUCT
void negExactL_rRegNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// cr
  st->print("negq    ");
  opnd_array(1)->ext_format(ra, this,idx1, st); // dst
  st->print("\t# negExact long");
}
#endif
#ifndef PRODUCT
...
#endif
#ifndef PRODUCT
void mulExactI_rRegNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
  ...
  st->print(", ");
  opnd_array(2)->ext_format(ra, this,idx2, st); // src
  st->print("\t# mulExact int");
}
#endif
#ifndef PRODUCT
void mulExactI_rReg_immNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// imm
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// dst
...
#endif
#ifndef PRODUCT
void mulExactI_rReg_memNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 2;
  unsigned idx1 = 2; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
...
#endif
#ifndef PRODUCT
void mulExactL_rRegNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
  ...
  st->print(", ");
  opnd_array(2)->ext_format(ra, this,idx2, st); // src
  st->print("\t# mulExact long");
}
#endif
#ifndef PRODUCT
void mulExactL_rReg_immNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 1;
  unsigned idx1 = 1; 	// imm
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// dst
...
#endif
#ifndef PRODUCT
void mulExactL_rReg_memNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  // Start at oper_input_base() and count operands
  unsigned idx0 = 2;
  unsigned idx1 = 2; 	// src
  unsigned idx2 = idx1 + opnd_array(1)->num_edges(); 	// cr
...
void rep_stosNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  st->print("xorq    rax, rax\t# ClearArray:\n\t");
...
void rep_fast_stosbNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  st->print("xorq    rax, rax\t# ClearArray:\n\t");
  st->print("shlq    rcx,3\t# Convert doublewords to bytes\n\t");
  st->print("rep     stosb\t# Store rax to *rdi++ while rcx--");
}
#endif
#ifndef PRODUCT
...
void partialSubtypeCheckNode::format(PhaseRegAlloc *ra, outputStream *st) const {
  ...
  st->print("movl    rcx, [rdi + Array<Klass*>::length_offset_in_bytes()]\t# length to scan\n\t");
  st->print("addq    rdi, Array<Klass*>::base_offset_in_bytes()\t# Skip to start of data; set NZ in case count is zero\n\t");
