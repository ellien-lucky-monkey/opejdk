...
const Pipeline *               addExactI_rRegNode::pipeline_class() { return (&pipeline_class_005); }
const Pipeline *               addExactI_rRegNode::pipeline() const { return (&pipeline_class_005); }

const Pipeline *           addExactI_rReg_immNode::pipeline_class() { return (&pipeline_class_005); }
const Pipeline *           addExactI_rReg_immNode::pipeline() const { return (&pipeline_class_005); }

const Pipeline *           addExactI_rReg_memNode::pipeline_class() { return (&pipeline_class_009); }
const Pipeline *           addExactI_rReg_memNode::pipeline() const { return (&pipeline_class_009); }

const Pipeline *               addExactL_rRegNode::pipeline_class() { return (&pipeline_class_005); }
const Pipeline *               addExactL_rRegNode::pipeline() const { return (&pipeline_class_005); }

const Pipeline *           addExactL_rReg_immNode::pipeline_class() { return (&pipeline_class_005); }
const Pipeline *           addExactL_rReg_immNode::pipeline() const { return (&pipeline_class_005); }

const Pipeline *           addExactL_rReg_memNode::pipeline_class() { return (&pipeline_class_009); }
const Pipeline *           addExactL_rReg_memNode::pipeline() const { return (&pipeline_class_009); }
...
const Pipeline *               subExactI_rRegNode::pipeline_class() { return (&pipeline_class_005); }
const Pipeline *               subExactI_rRegNode::pipeline() const { return (&pipeline_class_005); }

const Pipeline *           subExactI_rReg_immNode::pipeline_class() { return (&pipeline_class_005); }
const Pipeline *           subExactI_rReg_immNode::pipeline() const { return (&pipeline_class_005); }

const Pipeline *           subExactI_rReg_memNode::pipeline_class() { return (&pipeline_class_009); }
const Pipeline *           subExactI_rReg_memNode::pipeline() const { return (&pipeline_class_009); }

const Pipeline *               subExactL_rRegNode::pipeline_class() { return (&pipeline_class_005); }
const Pipeline *               subExactL_rRegNode::pipeline() const { return (&pipeline_class_005); }

const Pipeline *           subExactL_rReg_immNode::pipeline_class() { return (&pipeline_class_005); }
const Pipeline *           subExactL_rReg_immNode::pipeline() const { return (&pipeline_class_005); }

const Pipeline *           subExactL_rReg_memNode::pipeline_class() { return (&pipeline_class_009); }
const Pipeline *           subExactL_rReg_memNode::pipeline() const { return (&pipeline_class_009); }
...
const Pipeline *               negExactI_rRegNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *               negExactI_rRegNode::pipeline() const { return (&pipeline_class_001); }

const Pipeline *               negExactL_rRegNode::pipeline_class() { return (&pipeline_class_001); }
const Pipeline *               negExactL_rRegNode::pipeline() const { return (&pipeline_class_001); }
...
const Pipeline *               mulExactI_rRegNode::pipeline_class() { return (&pipeline_class_013); }
const Pipeline *               mulExactI_rRegNode::pipeline() const { return (&pipeline_class_013); }

const Pipeline *           mulExactI_rReg_immNode::pipeline_class() { return (&pipeline_class_013); }
const Pipeline *           mulExactI_rReg_immNode::pipeline() const { return (&pipeline_class_013); }

const Pipeline *           mulExactI_rReg_memNode::pipeline_class() { return (&pipeline_class_014); }
const Pipeline *           mulExactI_rReg_memNode::pipeline() const { return (&pipeline_class_014); }

const Pipeline *               mulExactL_rRegNode::pipeline_class() { return (&pipeline_class_013); }
const Pipeline *               mulExactL_rRegNode::pipeline() const { return (&pipeline_class_013); }

const Pipeline *           mulExactL_rReg_immNode::pipeline_class() { return (&pipeline_class_013); }
const Pipeline *           mulExactL_rReg_immNode::pipeline() const { return (&pipeline_class_013); }

const Pipeline *           mulExactL_rReg_memNode::pipeline_class() { return (&pipeline_class_014); }
const Pipeline *           mulExactL_rReg_memNode::pipeline() const { return (&pipeline_class_014); }
